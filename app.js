...
function overheadAnalysisHtml(data,project){
  ...
  return `<section class="analysis-overhead-section" aria-labelledby="analysisOverheadTitle"><div class="analysis-overhead-heading"><div><h2 id="analysisOverheadTitle" class="table-title">Overhead</h2><p class="table-subtitle">Company constants, current project capacity, and additive commercial percentages produce one Project Overhead amount.</p></div></div>
    ...
    <div class="analysis-overhead-grid">
      <article><h3>KSI Constants</h3><dl><div><dt>KSI Annual Overhead</dt><dd>${overheadMoney(overhead.annualOverhead)} / Year</dd></div><div><dt>KSI Annual Project Capacity</dt><dd>${overhead.annualCapacity===null?'—':`${formatAnalysisNumber(overhead.annualCapacity,2)} MWp / Year`}</dd></div><div><dt>Coefficient A</dt><dd><span>${overheadMoney(overhead.annualOverhead)} ÷ ${overhead.annualCapacity===null?'—':`${formatAnalysisNumber(overhead.annualCapacity,2)} MWp`}</span><strong>${overhead.coefficientA===null?'—':`${overheadMoney(overhead.coefficientA)} / MWp`}</strong></dd></div></dl></article>
...
function adminFinalCostHtml(data){
  ...
  const o=data.overhead,traceRows=[
    {Step:'Coefficient A',Formula:`${overheadMoney(o.annualOverhead)} ÷ ${o.annualCapacity===null?'—':`${formatAnalysisNumber(o.annualCapacity,2)} MWp`}`,Result:o.coefficientA===null?'—':`${overheadMoney(o.coefficientA)} / MWp`},
